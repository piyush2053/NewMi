      ...
      <div className="flex gap-2 border-t border-black/10 px-4 pb-3 pt-2 bg-bg1">
        {tabs.map((item) => {
          ...
          return (
            <div
              key={item.name}
              className={`flex flex-1 flex-col items-center justify-end gap-1 transition-colors duration-200 cursor-pointer ${
                isActive ? "text-bg2" : "text-black/50 dark:text-white/50 hover:text-bg2"
              }`}
